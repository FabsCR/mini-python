...
public interface IMiniPythonParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBlock([NotNull] MiniPythonParser.BlockContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MiniPythonParser.block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitBlock([NotNull] MiniPythonParser.BlockContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterPrimaryExpression([NotNull] MiniPythonParser.PrimaryExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MiniPythonParser.primaryExpression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitPrimaryExpression([NotNull] MiniPythonParser.PrimaryExpressionContext context);
